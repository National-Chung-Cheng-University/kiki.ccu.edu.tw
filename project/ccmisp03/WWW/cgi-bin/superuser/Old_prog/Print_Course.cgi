...
{
  print qq(
   <html><head><title>$SUB_SYSTEM_NAME開排課系統--列印當學期已開科目</title></head>
...
sub Format_Time()
{
  ...
  my @time = ("A","1","2","3","4","F","B","5","6","7","8","C","D","E");
  foreach $ele ( @{$rtime} ) {
