...
<center>
    ...
    <table border=1 width=640>
      ...
      <tr> <th>支援系所</th><td>$Support_Dept</td></tr>
      <tr> <th>支援年級</th><td>$Support_Grade</td></tr>
      <tr> <th>支援班別</th><td>$Support_Class</td></tr>
      <tr> <th>擋修系所</th><td>$Ban_Dept</td></tr>
      <tr> <th>擋修年級</th><td>$Ban_Grade</td></tr>
      <tr> <th>擋修班別</th><td>$Ban_Class</td></tr>
      <tr> <th>保留本系名額</th><td>$the_Course{reserved_number}</td> </tr>
      <tr> <th>篩選原則</th><td>$Principle[$the_Course{principle}]</td></tr>
      <tr> <th>支援通識科目</th><td>$cge{$the_Course{support_cge_type}}{cge_name}</td></tr>
      <TR> <TH>支援通識人數</TH><TD>$the_Course{support_cge_number}</TD></TR>
      <TR> <TH>先修科目</TH><TD>$Prerequisite_Course</TD></TR>
      <tr> <th>其他備註</th><td>$the_Course{note}&nbsp</td></tr>
    </table>
    <table width=640 border=0>
    <tr><th>
