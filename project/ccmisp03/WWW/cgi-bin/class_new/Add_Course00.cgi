...
#Renew_Session($Input{session_id});
...
sub DEPT_TABLE
{
    ...
    $DATA = $DATA . "	<tr><th bgcolor=#99ffff width=10%>文學院</th>\n";
    $DATA = $DATA . "       <th bgcolor=#99ffff width=10%>理學院</th>\n";
    $DATA = $DATA . "       <th bgcolor=#99ffff width=10%>社會科學院</th>\n";
    $DATA = $DATA . "       <th bgcolor=#99ffff width=10%>工學院</th>\n";
    $DATA = $DATA . "       <th bgcolor=#99ffff width=10%>管理學院</th>\n";
    $DATA = $DATA . "       <th bgcolor=#99ffff width=10%>法學院</th>\n";  
    $DATA = $DATA . "       <th bgcolor=#99ffff width=10%>教育學院</th>\n";
    $DATA = $DATA . "       <th bgcolor=#99ffff width=10%>其他</th>\n";        
    if( ($SUB_SYSTEM!=3) and ($SUB_SYSTEM!=4) ) {
      $DATA = $DATA . "       <th bgcolor=#99ffff width=15%>跨領域學程</th>\n";   ### 專班不列出
    }
    $DATA = $DATA . "   </tr>\n";
