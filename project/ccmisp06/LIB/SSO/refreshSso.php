...
if(defined('_TEST_PLATFORM')) { //測試平台
	//常數定義
        define('SYS_DOOR_URL', 'http://140.123.30.101/~ccmisp08/cgi-bin/class/'); //子系統端登入頁
        define('SYS_LOGIN_URL', 'http://140.123.30.101/~ccmisp08/cgi-bin/class/stu_login_SSO.php'); //子系統端登入確認程式
        define('SSO_DOOR_URL', 'http://140.123.4.217/'); //sso端首頁
} else { //正式平台
        define('SYS_DOOR_URL', 'http://kiki.ccu.edu.tw/~ccmisp06/cgi-bin/class/'); //子系統端登入頁
        define('SYS_LOGIN_URL', 'http://kiki.ccu.edu.tw/~ccmisp06/cgi-bin/class/stu_login_SSO.php'); //子系統端登入確認程式
