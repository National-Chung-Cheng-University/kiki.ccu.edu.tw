...
#############################################################################
#####  Create_Precourse_Selection.cgi
#####  產生選擇先修科目檔( $FileName )
#####  開課程式中, 需要選擇先修科目時, 點選 "選擇先修科目" 按鍵後, 跳出一個
#####  HTML視窗供選擇, 該HTML視窗即由執行此程式所產生. HTML視窗中因含有歷年
#####  開課資料, 故需動態產生. 本程式由 Generate_Teacher_Classification.pl 
#####  改寫.
#####
...
#####  Coder: Nidalap
#####  Updates: 
#####    2001/04/17 Created by Nidalap
#####    2014/02/21 從 BIN 搬過來，掛在管理子系統的「產生開課靜態網頁」連結下。 Nidalap :D~
#############################################################################
...
sub Create_HTML_Code()
{
  ...
  print HTML qq(          
          ...
          <BR>
          <CENTER>
          <INPUT type=button value="送出資料到主畫面" onclick="AddPrecourse(this.form)">
        </FORM>
		<P>
        <FONT size=-1>
...
sub Create_JS_Data_Code()
{
  ...
  print("完成，已產生 $precourse_count 筆資料。\n");
