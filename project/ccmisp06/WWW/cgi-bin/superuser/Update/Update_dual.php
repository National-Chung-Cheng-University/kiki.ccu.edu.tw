<?PHP
  ...
  $query_string = "SELECT dept, std_no FROM a30tdual WHERE isnull(waivedate,'') = ''";
  $query_string = "SELECT dept, std_no FROM a30tdual WHERE trim(waivedate) = '' OR waivedate IS NULL";
